...
func Spx_sign_debug(params *parameters.Parameters, M []byte, SK *SPHINCS_SK) *SPHINCS_SIG {
	// init
	...
	SIG.SIG_HT = hypertree.Ht_sign_debug(params, PK_FORS, SKseed, PKseed, idx_tree, idx_leaf)
